...
export class ProjectComponent implements OnInit {
  ...
  onpropertyClick(data: any) {
    const queryParams = { queryParams: { projectName: encodeURIComponent(data.property_name.replace(/\s+/g, '')), id: data.id } };
    this.route.navigate(['view-current-project'], queryParams)
  }
